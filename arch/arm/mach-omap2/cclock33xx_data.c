...
DEFINE_CLK_DIVIDER(dpll_core_m4_ck,
	"dpll_core_x2_ck",
	&dpll_core_x2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(dpll_core_m5_ck,
	"dpll_core_x2_ck",
	&dpll_core_x2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(dpll_core_m6_ck,
	"dpll_core_x2_ck",
	&dpll_core_x2_ck,
	0x0,
 ...
 * and ALT_CLK1/2)
 */
DEFINE_CLK_DIVIDER(dpll_ddr_m2_ck,
	"dpll_ddr_ck",
	&dpll_ddr_ck,
	0x0,
...
DEFINE_CLK_FIXED_FACTOR(dpll_ddr_m2_div2_ck,
	"dpll_ddr_m2_ck",
	&dpll_ddr_m2_ck,
	0x0,
	1, 2);
 ...
 * and ALT_CLK1/2)
 */
DEFINE_CLK_DIVIDER(dpll_disp_m2_ck,
	"dpll_disp_ck",
	&dpll_disp_ck,
	0x0,
...
DEFINE_CLK_FIXED_FACTOR(dpll_per_m2_div4_wkupdm_ck,
		"dpll_per_m2_ck",
		&dpll_per_m2_ck,
		0x0,
		1, 4);

DEFINE_CLK_FIXED_FACTOR(dpll_per_m2_div4_ck,
		"dpll_per_m2_ck",
		&dpll_per_m2_ck,
		0x0,
		1, 4);

DEFINE_CLK_FIXED_FACTOR(dpll_core_m4_div2_ck,
		"dpll_core_m4_ck",
		&dpll_core_m4_ck,
		0x0,
		1, 2);

DEFINE_CLK_FIXED_FACTOR(l4_rtc_gclk,
		"dpll_core_m4_ck",
		&dpll_core_m4_ck,
		0x0,
		1, 2);

DEFINE_CLK_FIXED_FACTOR(clk_24mhz,
		"dpll_per_m2_ck",
		&dpll_per_m2_ck,
		0x0,
		1, 8);
 ...
 */
DEFINE_CLK_FIXED_FACTOR(clkdiv32k_ck,
	"clk_24mhz",
	&clk_24mhz,
	0x0,
	1, 732);
...
DEFINE_CLK_GATE(ieee5000_fck, "dpll_core_m4_div2_ck", &dpll_core_m4_div2_ck, 0x0,
	AM33XX_CM_PER_IEEE5000_CLKCTRL, AM33XX_MODULEMODE_SWCTRL_SHIFT,
	0x0, NULL);
...
DEFINE_CLK_GATE(gpio0_dbclk, "gpio0_dbclk_mux_ck", &gpio0_dbclk_mux_ck, 0x0,
	AM33XX_CM_WKUP_GPIO0_CLKCTRL, AM33XX_OPTFCLKEN_GPIO0_GDBCLK_SHIFT,
	0x0, NULL);

DEFINE_CLK_GATE(gpio1_dbclk, "clkdiv32k_ick", &clkdiv32k_ick, 0x0,
	AM33XX_CM_PER_GPIO1_CLKCTRL, AM33XX_OPTFCLKEN_GPIO_1_GDBCLK_SHIFT,
	0x0, NULL);

DEFINE_CLK_GATE(gpio2_dbclk, "clkdiv32k_ick", &clkdiv32k_ick, 0x0,
	AM33XX_CM_PER_GPIO2_CLKCTRL, AM33XX_OPTFCLKEN_GPIO_2_GDBCLK_SHIFT,
	0x0, NULL);

DEFINE_CLK_GATE(gpio3_dbclk, "clkdiv32k_ick", &clkdiv32k_ick, 0x0,
	AM33XX_CM_PER_GPIO3_CLKCTRL, AM33XX_OPTFCLKEN_GPIO_3_GDBCLK_SHIFT,
	0x0, NULL);
...
DEFINE_CLK_FIXED_FACTOR(mmc_clk,
	"dpll_per_m2_ck",
	&dpll_per_m2_ck,
	0x0,
	1, 2);
...
DEFINE_CLK_DIVIDER_TABLE(gfx_fck_div_ck,
	"gfx_fclk_clksel_ck",
	&gfx_fclk_clksel_ck,
	0x0,
...
DEFINE_CLK_DIVIDER_TABLE(clkout2_div_ck,
	"sysclkout_pre_ck",
	&sysclkout_pre_ck,
	0x0,
