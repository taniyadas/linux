...
#define OMAP54XX_MODULEMODE_HWCTRL_SHIFT			0
#define OMAP54XX_MODULEMODE_SWCTRL_SHIFT			1
...
DEFINE_CLK_DIVIDER(dpll_abe_m2x2_ck,
	...
	OMAP54XX_DIVHS_0_4_SHIFT,
	OMAP54XX_DIVHS_0_4_WIDTH,
...
DEFINE_CLK_DIVIDER(abe_clk,
	...
	OMAP54XX_CLKSEL_OPP_0_1_SHIFT,
	OMAP54XX_CLKSEL_OPP_0_1_WIDTH,
	CLK_DIVIDER_POWER_OF_TWO,
	NULL);

DEFINE_CLK_FIXED_FACTOR(abe_iclk,
	"abe_clk",
	&abe_clk,
	0x0,
	1, 2);

DEFINE_CLK_FIXED_FACTOR(cm_core_custefuse_clk_div_ck,
	"sys_clkin_ck",
	&sys_clkin_ck,
	0x0,
	1, 2);
...
DEFINE_CLK_DIVIDER(dpll_core_h12x2_ck,
	"dpll_core_x2_ck",
	&dpll_core_x2_ck,
	0x0,
	OMAP54XX_CM_DIV_H12_DPLL_CORE,
	OMAP54XX_DIVHS_SHIFT,
	OMAP54XX_DIVHS_WIDTH,
	0x0,
	NULL);
...
DEFINE_CLK_DIVIDER(div_iva_hs_clk,
	...
	OMAP54XX_CLKSEL_0_1_SHIFT,
	OMAP54XX_CLKSEL_0_1_WIDTH,
	CLK_DIVIDER_POWER_OF_TWO,
	NULL);
...
DEFINE_CLK_DIVIDER(dpll_core_h11x2_ck,
	"dpll_core_x2_ck",
	&dpll_core_x2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(dpll_core_h13x2_ck,
	"dpll_core_x2_ck",
	&dpll_core_x2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(dpll_core_h14x2_ck,
	"dpll_core_x2_ck",
	&dpll_core_x2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(dpll_core_h22x2_ck,
	"dpll_core_x2_ck",
	&dpll_core_x2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(dpll_core_h23x2_ck,
	"dpll_core_x2_ck",
	&dpll_core_x2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(dpll_iva_h11x2_ck,
	"dpll_iva_x2_ck",
	&dpll_iva_x2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(dpll_iva_h12x2_ck,
	"dpll_iva_x2_ck",
	&dpll_iva_x2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(dpll_per_h11x2_ck,
	"dpll_per_x2_ck",
	&dpll_per_x2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(dpll_per_h12x2_ck,
	"dpll_per_x2_ck",
	&dpll_per_x2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(dpll_per_h14x2_ck,
	"dpll_per_x2_ck",
	&dpll_per_x2_ck,
	0x0,
...
static const char *dpll_unipro1_clkdcoldo_ck_parents[] = {
	"dpll_unipro1_ck",
};

static struct clk dpll_unipro1_clkdcoldo_ck;

static const struct clk_ops dpll_unipro1_clkdcoldo_ck_ops = {
};

static struct clk_hw_omap dpll_unipro1_clkdcoldo_ck_hw = {
	.hw = {
		.clk = &dpll_unipro1_clkdcoldo_ck,
	},
	.clksel_reg	= OMAP54XX_CM_CLKDCOLDO_DPLL_UNIPRO1,
};

DEFINE_STRUCT_CLK(dpll_unipro1_clkdcoldo_ck, dpll_unipro1_clkdcoldo_ck_parents, dpll_unipro1_clkdcoldo_ck_ops);

DEFINE_CLK_DIVIDER(dpll_unipro1_m2_ck,
	"dpll_unipro1_ck",
	&dpll_unipro1_ck,
	0x0,
	OMAP54XX_CM_DIV_M2_DPLL_UNIPRO1,
	OMAP54XX_DIVHS_0_6_SHIFT,
	OMAP54XX_DIVHS_0_6_WIDTH,
	0x0,
	NULL);
...
static const char *dpll_unipro2_clkdcoldo_ck_parents[] = {
	"dpll_unipro2_ck",
};

static struct clk dpll_unipro2_clkdcoldo_ck;

static struct clk_hw_omap dpll_unipro2_clkdcoldo_ck_hw = {
	.hw = {
		.clk = &dpll_unipro2_clkdcoldo_ck,
	},
	.clksel_reg	= OMAP54XX_CM_CLKDCOLDO_DPLL_UNIPRO2,
};

DEFINE_STRUCT_CLK(dpll_unipro2_clkdcoldo_ck, dpll_unipro2_clkdcoldo_ck_parents, dpll_unipro1_clkdcoldo_ck_ops);

DEFINE_CLK_DIVIDER(dpll_unipro2_m2_ck,
	"dpll_unipro2_ck",
	&dpll_unipro2_ck,
	0x0,
...
DEFINE_STRUCT_CLK(dpll_usb_clkdcoldo_ck, dpll_usb_clkdcoldo_ck_parents, dpll_unipro1_clkdcoldo_ck_ops);
...
DEFINE_CLK_FIXED_FACTOR(func_24m_fclk,
	"dpll_per_m2x2_ck",
	&dpll_per_m2x2_ck,
	0x0,
	1, 8);

DEFINE_CLK_FIXED_FACTOR(func_48m_fclk,
	"dpll_per_m2x2_ck",
	&dpll_per_m2x2_ck,
	0x0,
	1, 4);

DEFINE_CLK_FIXED_FACTOR(func_96m_fclk,
	"dpll_per_m2x2_ck",
	&dpll_per_m2x2_ck,
	0x0,
	1, 2);
...
DEFINE_CLK_DIVIDER(l3_div_ck,
	...
	OMAP54XX_CLKSEL_L3_SHIFT,
	OMAP54XX_CLKSEL_L3_WIDTH,
	0x0,
	NULL);
...
DEFINE_CLK_DIVIDER_TABLE(l3init_60m_fclk,
	"dpll_usb_m2_ck",
	&dpll_usb_m2_ck,
	0x0,
...
DEFINE_CLK_DIVIDER(l4_div_ck,
	...
	0x0,
	OMAP54XX_CM_CLKSEL_CORE,
	OMAP54XX_CLKSEL_L4_SHIFT,
	OMAP54XX_CLKSEL_L4_WIDTH,
	0x0,
	NULL);
...
DEFINE_STRUCT_CLK(syc_clk_div_ck, dpll_core_ck_parents, dpll_unipro1_clkdcoldo_ck_ops);

static const char *wkupaon_clk_mux_ck_parents[] = {
	"sys_clkin_ck",
	"lp_clk_div_ck",
};

DEFINE_CLK_MUX(wkupaon_clk_mux_ck,
	wkupaon_clk_mux_ck_parents, NULL,
	0x0,
	OMAP54XX_CM_CLKSEL_WKUPAON,
	OMAP54XX_CLKSEL_0_0_SHIFT,
	OMAP54XX_CLKSEL_0_0_WIDTH,
...
DEFINE_STRUCT_CLK(lli_txphy_ls_clk, lli_txphy_ls_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(sata_ref_clk, dpll_core_ck_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(slimbus1_slimbus_clk, slimbus1_slimbus_clk_parents, dss_32khz_clk_ops);

static const char *slimbus2_slimbus_clk_parents[] = {
...
DEFINE_STRUCT_CLK(slimbus2_slimbus_clk, slimbus2_slimbus_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_host_hs_hsic480m_p1_clk, usb_host_hs_hsic480m_p1_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_host_hs_hsic480m_p2_clk, usb_host_hs_hsic480m_p1_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_host_hs_hsic480m_p3_clk, usb_host_hs_hsic480m_p1_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_host_hs_hsic60m_p1_clk, usb_host_hs_hsic60m_p1_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_host_hs_hsic60m_p2_clk, usb_host_hs_hsic60m_p1_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_host_hs_hsic60m_p3_clk, usb_host_hs_hsic60m_p1_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_host_hs_utmi_p1_clk, usb_host_hs_utmi_p1_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_host_hs_utmi_p2_clk, usb_host_hs_utmi_p2_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_host_hs_utmi_p3_clk, usb_host_hs_hsic60m_p1_clk_parents, dss_32khz_clk_ops);

static const char *usb_otg_ss_refclk960m_ck_parents[] = {
	"dpll_usb_clkdcoldo_ck",
};

static struct clk usb_otg_ss_refclk960m_ck;

static struct clk_hw_omap usb_otg_ss_refclk960m_ck_hw = {
	.hw = {
		.clk = &usb_otg_ss_refclk960m_ck,
	},
	.clkdm_name	= "l3init_clkdm",
...
DEFINE_STRUCT_CLK(usb_otg_ss_refclk960m_ck, usb_otg_ss_refclk960m_ck_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_tll_hs_usb_ch0_clk, usb_host_hs_hsic60m_p1_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_tll_hs_usb_ch1_clk, usb_host_hs_hsic60m_p1_clk_parents, dss_32khz_clk_ops);
...
DEFINE_STRUCT_CLK(usb_tll_hs_usb_ch2_clk, usb_host_hs_hsic60m_p1_clk_parents, dss_32khz_clk_ops);

DEFINE_CLK_GATE(ocp2scp1_ick, "l4_div_ck", &l4_div_ck, 0x0,
	OMAP54XX_CM_L3INIT_OCP2SCP1_CLKCTRL, OMAP54XX_MODULEMODE_HWCTRL_SHIFT,
	0x0, NULL);

DEFINE_CLK_GATE(ocp2scp3_ick, "l4_div_ck", &l4_div_ck, 0x0,
	OMAP54XX_CM_L3INIT_OCP2SCP3_CLKCTRL, OMAP54XX_MODULEMODE_HWCTRL_SHIFT,
	0x0, NULL);
...
DEFINE_CLK_MUX(dmic_gfclk,
	dmic_gfclk_parents, NULL,
	0x0,
	OMAP54XX_CM_ABE_DMIC_CLKCTRL,
...
static const char *gpu_core_clk_mux_ck_parents[] = {
	"dpll_core_h14x2_ck",
	"dpll_per_h14x2_ck",
};

DEFINE_CLK_MUX(gpu_core_clk_mux_ck,
	gpu_core_clk_mux_ck_parents, NULL,
	0x0,
...
DEFINE_CLK_MUX(gpu_hyd_clk_mux_ck,
	gpu_core_clk_mux_ck_parents, NULL,
	0x0,
	OMAP54XX_CM_GPU_GPU_CLKCTRL,
...
DEFINE_CLK_MUX(mcasp_gfclk,
	mcasp_gfclk_parents, NULL,
	0x0,
	OMAP54XX_CM_ABE_MCASP_CLKCTRL,
	OMAP54XX_CLKSEL_SOURCE_SHIFT,
	OMAP54XX_CLKSEL_SOURCE_WIDTH,
...
DEFINE_CLK_MUX(mcbsp1_gfclk,
	mcbsp1_gfclk_parents, NULL,
	0x0,
	OMAP54XX_CM_ABE_MCBSP1_CLKCTRL,
	OMAP54XX_CLKSEL_SOURCE_SHIFT,
	OMAP54XX_CLKSEL_SOURCE_WIDTH,
...
DEFINE_CLK_MUX(mcbsp2_gfclk,
	mcbsp2_gfclk_parents, NULL,
	0x0,
	OMAP54XX_CM_ABE_MCBSP2_CLKCTRL,
	OMAP54XX_CLKSEL_SOURCE_SHIFT,
	OMAP54XX_CLKSEL_SOURCE_WIDTH,
...
DEFINE_CLK_MUX(mcbsp3_gfclk,
	mcbsp3_gfclk_parents, NULL,
	0x0,
	OMAP54XX_CM_ABE_MCBSP3_CLKCTRL,
	OMAP54XX_CLKSEL_SOURCE_SHIFT,
	OMAP54XX_CLKSEL_SOURCE_WIDTH,
...
static const char *mmc1_fclk_mux_ck_parents[] = {
	"dpll_per_h11x2_ck",
	"dpll_per_m2x2_ck",
};

DEFINE_CLK_MUX(mmc1_fclk_mux_ck,
	mmc1_fclk_mux_ck_parents, NULL,
	0x0,
	OMAP54XX_CM_L3INIT_MMC1_CLKCTRL,
	OMAP54XX_CLKSEL_SOURCE_24_24_SHIFT,
	OMAP54XX_CLKSEL_SOURCE_24_24_WIDTH,
	0x0,
	NULL);

DEFINE_CLK_DIVIDER(mmc1_fclk,
	"mmc1_fclk_mux_ck",
	&mmc1_fclk_mux_ck,
	0x0,
	OMAP54XX_CM_L3INIT_MMC1_CLKCTRL,
...
DEFINE_CLK_MUX(mmc2_fclk_mux_ck,
	mmc1_fclk_mux_ck_parents, NULL,
	0x0,
...
DEFINE_CLK_MUX(timer10_clk_mux_ck,
	abe_dpll_bypass_clk_mux_ck_parents, NULL,
	0x0,
...
DEFINE_CLK_MUX(timer11_clk_mux_ck,
	abe_dpll_bypass_clk_mux_ck_parents, NULL,
	0x0,
...
DEFINE_CLK_MUX(timer1_clk_mux_ck,
	abe_dpll_bypass_clk_mux_ck_parents, NULL,
	0x0,
...
DEFINE_CLK_MUX(timer2_clk_mux_ck,
	abe_dpll_bypass_clk_mux_ck_parents, NULL,
	0x0,
...
DEFINE_CLK_MUX(timer3_clk_mux_ck,
	abe_dpll_bypass_clk_mux_ck_parents, NULL,
	0x0,
...
DEFINE_CLK_MUX(timer4_clk_mux_ck,
	abe_dpll_bypass_clk_mux_ck_parents, NULL,
	0x0,
...
static const char *timer5_sync_mux_ck_parents[] = {
	"syc_clk_div_ck",
	"sys_32k_ck",
};

DEFINE_CLK_MUX(timer5_sync_mux_ck,
	timer5_sync_mux_ck_parents, NULL,
	0x0,
...
DEFINE_CLK_MUX(timer6_sync_mux_ck,
	timer5_sync_mux_ck_parents, NULL,
	0x0,
...
DEFINE_CLK_MUX(timer7_sync_mux_ck,
	timer5_sync_mux_ck_parents, NULL,
	0x0,
...
DEFINE_CLK_MUX(timer8_sync_mux_ck,
	timer5_sync_mux_ck_parents, NULL,
	0x0,
...
DEFINE_CLK_MUX(timer9_clk_mux_ck,
	abe_dpll_bypass_clk_mux_ck_parents, NULL,
	0x0,
...
static const struct clk_div_table ts_clk_div_ck_rates[] = {
	{ .div = 8, .val = 0 },
	{ .div = 16, .val = 1 },
	{ .div = 32, .val = 2 },
	{ .div = 0 },
};
DEFINE_CLK_DIVIDER_TABLE(ts_clk_div_ck,
	"wkupaon_clk_mux_ck",
	&wkupaon_clk_mux_ck,
	0x0,
	OMAP54XX_CM_COREAON_BANDGAP_CLKCTRL,
	OMAP54XX_CLKSEL_24_25_SHIFT,
	OMAP54XX_CLKSEL_24_25_WIDTH,
	0x0,
	ts_clk_div_ck_rates,
	NULL);
...
static struct omap_clk omap54xx_clks[] = {
	...
	CLK(NULL,	"mmc1_fclk_mux_ck",		&mmc1_fclk_mux_ck,	CK_54XX),
	CLK(NULL,	"mmc1_fclk",			&mmc1_fclk,	CK_54XX),
	CLK(NULL,	"mmc2_fclk_mux_ck",		&mmc2_fclk_mux_ck,	CK_54XX),
	...
	CLK(NULL,	"timer10_clk_mux_ck",		&timer10_clk_mux_ck,	CK_54XX),
	CLK(NULL,	"timer11_clk_mux_ck",		&timer11_clk_mux_ck,	CK_54XX),
	CLK(NULL,	"timer1_clk_mux_ck",		&timer1_clk_mux_ck,	CK_54XX),
	CLK(NULL,	"timer2_clk_mux_ck",		&timer2_clk_mux_ck,	CK_54XX),
	CLK(NULL,	"timer3_clk_mux_ck",		&timer3_clk_mux_ck,	CK_54XX),
	CLK(NULL,	"timer4_clk_mux_ck",		&timer4_clk_mux_ck,	CK_54XX),
	...
	CLK(NULL,	"timer9_clk_mux_ck",		&timer9_clk_mux_ck,	CK_54XX),
